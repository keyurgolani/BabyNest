...
const topActions = [
  {
    ...
    borderColor: "border-[var(--color-sleep)]/20",
  ...
  },
  {
    ...
    borderColor: "border-[var(--color-diaper)]/20",
  ...
  },
  {
    ...
    label: "Feed",
    icon: BreastfeedIcon,
    color: "text-[var(--color-nursing)]",
    bg: "bg-[var(--color-nursing)]/10",
    borderColor: "border-[var(--color-nursing)]/20",
...
const mobileOnlyActions = [
  {
    ...
    label: "Medicine",
    icon: Pill,
    color: "text-[var(--color-medicine)]",
    bg: "bg-[var(--color-medicine)]/10",
    borderColor: "border-[var(--color-medicine)]/20",
  ...
  },
  {
    ...
    label: "Solids",
    icon: Apple,
    color: "text-[var(--color-growth)]",
    bg: "bg-[var(--color-growth)]/10",
    borderColor: "border-[var(--color-growth)]/20",
  ...
  },
  {
    ...
    label: "Vaccine",
    icon: Syringe,
    color: "text-[var(--color-activity)]",
    bg: "bg-[var(--color-activity)]/10",
    borderColor: "border-[var(--color-activity)]/20",
    glow: "shadow-[0_4px_16px_rgba(90,154,184,0.2),0_0_25px_rgba(90,154,184,0.15)]",
    hoverGlow: "hover:shadow-[0_8px_24px_rgba(90,154,184,0.3),0_0_40px_rgba(90,154,184,0.25)]",
  },
  {
  ...
  },
  {
    ...
    borderColor: "border-[var(--color-feed)]/20",
  ...
  },
  {
    ...
    label: "Temp",
    icon: Thermometer,
    color: "text-[var(--color-health)]",
    bg: "bg-[var(--color-health)]/10",
    borderColor: "border-[var(--color-health)]/20",
